...
$.extend($.easing, {
        ...
        var e = {
            init: function () {
                ...
                Wolmart.call(Wolmart.ratingTooltip, 500),
                    ...
                    //                       actionTemplate: '<a href="cart.php" class="btn btn-rounded btn-sm">View Cart</a><a href="checkout.php" class="btn btn-dark btn-rounded btn-sm">Checkout</a>',
                    //                   });
                    //           }, 500));
                    // }),
                    ...
                    (function () {
                        ...
                        a.length ||
                            ...
                            (t(".page-wrapper").append(
                                '<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="compare.php" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'
                            ),
                            (a = t(".page-wrapper > .compare-popup"))),
                            Wolmart.$body
                                .on("click", ".product .btn-compare", function (o) {
                                    ...
                                    s.hasClass("added") && returne(),
                                        ...
                                        setTimeout(function () {
                                            s.removeClass("load-more-overlay loading"), s.toggleClass("w-icon-compare").toggleClass("w-icon-check-solid"), s.attr("href", "compare.php"), a.addClass("show");
                                        }, 500);
                                    ...
                                    i.length >= 4 && i.shift(),
                                        ...
                                        t(".compare-popup li").each(function (t) {
                                            i[t] &&
                                                (this.innerHTML =
                                                    '<a href="product-default.php"><figure><img src="' +
                                                    i[t] +
        ...
        var i = function () {
            ...
            a = function (e) {
                ...
                i.hasClass("added") ||
                    ...
                    setTimeout(function () {
                        i.removeClass("load-more-overlay loading").toggleClass("w-icon-heart").toggleClass("w-icon-heart-full").addClass("added").attr("href", "wishlist.php");
                    }, 500));
            },
            n = function (e) {
    ...
    (function (t) {
        ...
        //         else {
        //             var n =
        //                 '<div class="alert alert-success alert-cart-product mb-2">                            <a href="cart.php" class="btn btn-success btn-rounded">View Cart</a>                            <p class="mb-0 ls-normal">“' +
                ...
                Wolmart.$body.on("click", ".show-code", function (e) {
                    ...
                    if (i.hasClass("show-code-added")) {
                        ...
                        i[0].removeChild(a),
                            ...
                            t(".code-copy a").php('<i class="copy-icon far fa-copy"></i>Copy to Clipboard'),
                            Wolmart.$body.on("click", ".code-copy a", function (e) {
                                e.preventDefault(), t(".code-popup #textareaCode").trigger("select"), document.execCommand("copy"), t(this).php('<i class="copy-icon far fa-copy"></i>Copied');
                            }),
                            setTimeout(function () {
    ...
    (function (t) {
        ...
        var i = function (t) {
            ...
            (i += e.settings.displayYear ? " " + t.getFullYear() : ""), e.element.find(".calendar-title").php(i);
        };
        (e.defaultOptions = {
