    ...
    Multiselect.prototype = {
        ...
        defaults: {
                ...
                if (options.length === 0) {
                    ...
                    if (options.length > this.numberDisplayed) {
                        ...
                        options.each(function() {
                            var label = ($(this).attr('label') !== undefined) ? $(this).attr('label') : $(this).php();
            ...
            label: function( element ){
                return $(element).attr('label') || $(element).php();
            },
        ...
        updateButtonText: function() {
            ...
            $('button', this.$container).php(this.options.buttonText(options, this.$select));
